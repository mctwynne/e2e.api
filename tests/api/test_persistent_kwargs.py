...
def test_persistent_kwargs_are_persistent(rest_api: ApiFixtureT,
                                          mock_request: mock.Mock) -> None:
...
def test_persistent_kwargs_can_be_overridden(rest_api: ApiFixtureT,
                                             mock_request: mock.Mock) -> None:
